        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    printf(esc_html__('Theme: %1$s by %2$s.', 'elegant-magazine'), '<a href="https://afthemes.com/products/elegant-magazine/">Elegant Magazine</a>', '<a href="https://afthemes.com/">AF themes</a>');
                    ?>
                </div>
            </div>
        </div>
